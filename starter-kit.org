...
#+begin_src emacs-lisp
  (setq yas-mine (expand-file-name "snippets" dotfiles-dir))
  (setq yas-dist (concat dotfiles-dir "src/yasnippet/snippets"))
  (setq yas/root-directory (list yas-mine yas-dist))

...
#+begin_src emacs-lisp
  ...
  (setq org-capture-templates
        '(("t" "Todo" entry (file+headline org-default-notes-file "Captured items")
           "* TODO %?\n:LOGBOOK:\n- Created on %U\n:END:\n%i\n%a"
           :empty-lines 1)
          ("x" "org-protocol" entry (file+headline org-default-notes-file "Captured items")
           "* TODO %:description\n:LOGBOOK:\n- Created on %U\n:END:\nSource: %:link\n#+begin_quote\n%:initial\n#+end_quote"
...
** Agenda
org-agenda-file is managed by the customizing feature of Emacs.
